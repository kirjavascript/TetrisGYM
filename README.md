...
2. **Install Node.js**
   ...
   - On macOS: Use Homebrew by running `brew install node` in the terminal.
   - On Windows and other platforms: Download the installer from [Node.js official website](https://nodejs.org/).

3. **Install cc65**
   - Install the cc65 compiler.
   - On macOS: Use Homebrew by running `brew install cc65`.
   - On Windows and other systems: Refer to the [cc65 GitHub repository](https://github.com/cc65/cc65) for installation instructions.

4. **Prepare the Tetris ROM**
   - Obtain a copy of the unpatched Tetris ROM.
   - Rename this file to `clean.nes` and place it in the project's root directory.
...
6. **Completion**
   - After the build process completes, a new Tetris ROM will be created, incorporating the modifications from this project.

**Note:** Make sure to have the necessary permissions to use the Tetris ROM and comply with all relevant software licenses.
